...
//{
    ...
    //float scaleV = - (fragTexCoord.y - ss_box_pos.y) / (ss_box_dim.y);

    //vec3 clamp_color = clamp(blend_color, 0.0f, 1.0f);

    //finalColor = vec4(hsv2rgb(rgb2hsv(clamp_color)*vec3(1.0f,scaleS,scaleV)),1.0f);
    ////finalColor = vec4(1.0f, scaleS, scaleV, 1.0f);
//}
#version 330
