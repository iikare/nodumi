...
void drawTextEx(string msg, Vector2 pos, colorRGB col, unsigned char alpha = 255, int size = 14, string font = DEFAULT_FONT);
void drawTextEx(string msg, int x, int y, colorRGB col, unsigned char alpha = 255, int size = 14, string font = DEFAULT_FONT);
void drawSymbol(int sym, int size, int x, int y, colorRGB col, unsigned char alpha = 255);
...
Vector2 measureTextEx(string msg, int size = 14, string font = DEFAULT_FONT);
