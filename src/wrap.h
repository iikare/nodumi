...
void drawTextEx(string msg, Vector2 pos, colorRGB col, unsigned char alpha = 255, int size = 14, string font = "YKLIGHT");
void drawTextEx(string msg, int x, int y, colorRGB col, unsigned char alpha = 255, int size = 14, string font = "YKLIGHT");
...
Vector2 measureTextEx(string msg, int size = 14, string font = "YKLIGHT");
