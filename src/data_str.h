...
#define LABEL_LANG_EN                                                         \
  unordered_map<string, string> {                                             \
    {"FILE_MENU_FILE", "File"}, {"FILE_MENU_OPEN_FILE", "Open File"},         \
        {"FILE_MENU_OPEN_IMAGE", "Open Image"}, {"FILE_MENU_SAVE", "Save"},   \
        ...
        {"VIEW_MENU_HIDE_FPS", "Hide FPS"}, {"DISPLAY_MENU_DEFAULT", "Bar"},  \
        {"DISPLAY_MENU_LINE", "Line"}, {"DISPLAY_MENU_PULSE", "Pulse"},       \
        {"DISPLAY_MENU_BALL", "Ball"}, {"DISPLAY_MENU_FFT", "FFT"},           \
        {"DISPLAY_MENU_VORONOI", "Voronoi"}, {"DISPLAY_MENU_LOOP", "Loop"},   \
        {"SONG_MENU_RELATIVE", "Relative"},                                   \
        {"SONG_MENU_ABSOLUTE", "Absolute"}, {"MIDI_MENU_MIDI", "Midi"},       \
        {"MIDI_MENU_INPUT", "Input"}, {"MIDI_MENU_OUTPUT", "Output"},         \
        {"MIDI_MENU_ENABLE_LIVE_PLAY", "Enable Live Play"},                   \
        {"MIDI_MENU_DISABLE_LIVE_PLAY", "Disable Live Play"},                 \
        {"COLOR_MENU_COLOR", "Color"}, {"COLOR_MENU_COLOR_BY", "Color By:"},  \
        {"COLOR_MENU_COLOR_SCHEME", "Color Scheme:"},                         \
        {"COLOR_MENU_SWAP_COLORS", "Swap Colors"},                            \
        {"COLOR_MENU_INVERT_COLOR_SCHEME", "Invert Color Scheme"},            \
        {"SCHEME_MENU_PART", "Part"}, {"SCHEME_MENU_VELOCITY", "Velocity"},   \
        {"SCHEME_MENU_TONIC", "Tonic"}, {"INFO_MENU_INFO", "Info"},           \
        {"INFO_MENU_PROGRAM_INFO", "Program Info"},                           \
        {"INFO_MENU_FILE_INFO", "File Info"}, {"INFO_MENU_HELP", "Help"},     \
        ...
        {"GET_SONG_INFO_TRACK", "Track"}, {"GET_LABEL_MAJOR", "Major"},       \
        {"WIN_WARN_MSG_EXPERIMENTAL",                                         \
         "WARNING: windows version is experimental"},                         \
        {"INFO_BOX_BUILD_DATE", "Build Date:"}, {"INFO_BOX_VER", "Ver."},     \
        {"INFO_BOX_LICENSE_GPL3", "Licensed under GPLv3"},                    \
        {"PREF_LABEL", "Preferences"}, {"PREF_P1", "Display"},                \
        {"PREF_P2", "Effects"},                                               \
        ...
        {"FILE_INFO_LABEL", "Information"}, {"FILE_TYPE", "Format"},          \
