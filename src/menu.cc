...
string menuItem::getContent() const { return content; }

int menuItem::getX() const { return x; }

int menuItem::getY() const { return y; }

int menuItem::getWidth() const { return width; }

int menuItem::getHeight() const { return height; }

void menuItem::setContent(const string& nContent) { content = nContent; }

void menuItem::setX(int nX) { x = nX; }

void menuItem::setY(int nY) { y = nY; }

void menuItem::setWidth(int nWidth) { width = nWidth; }
...
void menu::addChildMenu(menu* child) { childMenu.push_back(child); }
...
void menu::findMenuLocation(int& rcX, int& rcY) const {
  ...
  if (ctr.getMouseY() + getHeight() > mainYMax) {
    // the menu would go off the bottom of the screen, set the bounds to end at
    // the bottom margin
